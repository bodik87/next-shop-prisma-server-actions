    ...
    <Dialog as="div" className="fixed inset-0 px-3 z-30" onClose={closeModal}>
     <div className="relative wrapper">
      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center">
       ...
       >
        <Dialog.Panel className="max-w-xs absolute top-[140px] left-0 w-full transform overflow-hidden rounded bg-white text-left align-middle shadow-xl transition-all">
